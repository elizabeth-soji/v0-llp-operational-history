...
export default function FolderIPage() {
  const folderInfo = {
    letter: "I",
    name: "Landing Gear Records",
    progress: 48,
    status: "in-progress",
    documents: 5,
  }
  ...
  const subfolders = [
    {
      code: "I 001",
      name: "Manufacturer report of Life Limited Parts installed at Manufacture (for installed Landing Gear), including Part Number and Serial Number",
      progress: 100,
      documents: 1,
    ...
    {
      code: "I 002",
      name: "Authorized Release Certificate from last Overhaul of each major Landing Gear Assembly",
      progress: 80,
      documents: 1,
    ...
    {
      code: "I 003",
      name: "Certified status of Life Limited Parts of each Landing Gear showing cycle limit, cycles consumed since new, and cycles remaining",
      progress: 60,
      documents: 1,
    ...
    {
      code: "I 005",
      name: "Individual total cycle substantiation data for each Life Limited Part (as identified by applicable OEM document) since manufacture",
      progress: 20,
      documents: 1,
          ...
          <div className="bg-white">
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  <div className="h-16 w-16 rounded-lg bg-orange-50 border-2 border-orange-200 flex items-center justify-center">
                    <span className="text-3xl font-bold text-orange-600">{folderInfo.letter}</span>
                  </div>
                  <div>
              ...
              {/* Subfolders Section */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-4">Landing Gear Records</h3>
                      ...
                      <CardHeader className="pb-3">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            <div className="h-12 w-12 rounded-lg bg-orange-50 border border-orange-200 flex items-center justify-center flex-shrink-0">
                              <FileText className="h-6 w-6 text-orange-600" />
                            </div>
                            <div>
                              <div className="text-xs font-semibold text-orange-600 mb-1">{subfolder.code}</div>
                      ...
                      <CardContent className="space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-slate-200">
                          ...
                          <div className="flex items-center gap-1 text-xs text-slate-600">
                            ...
                            <span className="font-semibold text-orange-600">{subfolder.party}</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>

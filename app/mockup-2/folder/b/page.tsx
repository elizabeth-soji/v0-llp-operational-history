...
import { ArrowLeft, Download, Clock, FileText, Upload, Plus, FolderOpen, ChevronRight, Folder, User } from 'lucide-react'
import { Button } from "@/components/ui/button"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import { Progress } from "@/components/ui/progress"

export default function FolderBPage() {
  const folderInfo = {
    letter: "B",
        ...
        <div className="mt-6">
          ...
          <div className="bg-white">
            <div className="p-6">
              ...
              {/* Subfolders Section */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-4">Maintenance Status Summary Documents</h3>
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    {
                      code: "B 001",
                      name: "Certified listing of Airframe Check / Inspection History / Maintenance Checks performed",
                      progress: 100,
                      status: "complete",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 002",
                      name: "Certified status of Total Time in Service",
                      progress: 100,
                      status: "complete",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 003",
                      name: "Aircraft Flight Time Report / Aircraft Log Book / or Airline Maintenance Information System (MIS) utilization report",
                      progress: 85,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 004",
                      name: "Certified status of Airframe & Appliance (Component) Airworthiness Directives",
                      progress: 75,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 005",
                      name: "Certified status of Manufacturer Service Bulletins incorporated",
                      progress: 90,
                      status: "in-progress",
                      priority: "medium",
                      documents: 1,
                    ...
                    {
                      code: "B 006",
                      name: "Certified status of all Airframe Non-Manufacturer Modifications incorporated, including STC's",
                      progress: 60,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 007",
                      name: "Certified status of compliance with the Redelivering Airline's Approved Maintenance Program",
                      progress: 100,
                      status: "complete",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 008",
                      name: "Certified status of supplemental structural inspections (SSIs) or ALS items (Airbus) as applicable",
                      progress: 70,
                      status: "in-progress",
                      priority: "medium",
                      documents: 1,
                    ...
                    {
                      code: "B 009",
                      name: "Certified status of CPCP / ISIP Tasks (if applicable)",
                      progress: 55,
                      status: "in-progress",
                      priority: "medium",
                      documents: 1,
                    ...
                    {
                      code: "B 010",
                      name: "Certified status of Certification Maintenance Requirements (CMR)",
                      progress: 80,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 011",
                      name: "Certified status of Airworthiness Limitation Items (ALIs)",
                      progress: 95,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 012",
                      name: "Certified list of deferred maintenance items",
                      progress: 100,
                      status: "complete",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 013",
                      name: "Certified status of installed Time Controlled Components",
                      progress: 65,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 014",
                      name: "Certified status of Life Limited Airframe Parts",
                      progress: 70,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 015",
                      name: "Certified listing of OCCM Components",
                      progress: 50,
                      status: "in-progress",
                      priority: "medium",
                      documents: 1,
                    ...
                    {
                      code: "B 016",
                      name: "Certified Incident/Accident Clearance Statement",
                      progress: 100,
                      status: "complete",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 017",
                      name: "Certified listing of internal and external structural repairs & allowable damage and Certified map",
                      progress: 60,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 018",
                      name: "Certified statement of Oil and Fluid types used in Aircraft, Engines and APU",
                      progress: 100,
                      status: "complete",
                      priority: "medium",
                      documents: 1,
                    ...
                    {
                      code: "B 019",
                      name: "Certified listing of installed Operator loadable software including part number and revision date",
                      progress: 45,
                      status: "in-progress",
                      priority: "medium",
                      documents: 1,
                    ...
                    {
                      code: "B 020",
                      name: "Evidence of aircraft operational capability (e.g. RVSM, RNP, ETOPS, Landing Category, MNPS, FANS, FM Immunity, 8.33 Spacing, ADS-B)",
                      progress: 85,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 021",
                      name: "Certified Flight Data Recorder report",
                      progress: 75,
                      status: "in-progress",
                      priority: "medium",
                      documents: 1,
                    ...
                    {
                      code: "B 022",
                      name: "Approved Maintenance Program summary of Redelivering Airline",
                      progress: 90,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,
                    ...
                    {
                      code: "B 023",
                      name: "Certified Cockpit Voice Recorder report",
                      progress: 80,
                      status: "in-progress",
                      priority: "medium",
                      documents: 1,
                    ...
                    <Card key={subfolder.code} className="hover:shadow-md transition-all cursor-pointer group relative overflow-hidden bg-white border-slate-200">
                      <div
                        className={`absolute top-0 left-0 right-0 h-1 ${
                          subfolder.status === "complete"
                            ? "bg-emerald-500"
                      ...
                      <CardContent className="space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-slate-200">
                          <span className="text-xs text-slate-500">Last updated {subfolder.lastUpdate}</span>
                          <div className="flex items-center gap-1 text-xs text-slate-600">
                            <User className="h-3 w-3" />
                            <span>{subfolder.assignee}</span>
                            <span className="text-slate-400">•</span>
                            <span className="font-semibold text-blue-600">{subfolder.party}</span>
                          </div>
                        </div>

...
export default function FolderJPage() {
  const folderInfo = {
    letter: "J",
    name: "Manuals",
    progress: 95,
  ...
  const subfolders = [
    {
      code: "J 001",
      name: "Airplane Flight Manual (including all supplements acceptable to the Aircraft state of design)",
      progress: 100,
      documents: 1,
    ...
    {
      code: "J 006",
      name: "Wire List and Hookup charts",
      progress: 95,
      documents: 1,
    ...
    {
      code: "J 007",
      name: "Aircraft Operating Manual",
      progress: 100,
      documents: 1,
      lastUpdate: "1 day ago",
      assignee: "Anna P.",
    ...
    {
      code: "J 009",
      name: "Weight and Balance Manual",
      progress: 100,
      documents: 1,
      lastUpdate: "1 day ago",
      assignee: "Sarah C.",
    ...
    {
      code: "J 010",
      name: "Power Plant Buildup Manual",
      progress: 95,
      documents: 1,
    ...
    {
      code: "J 013",
      name: "Engine Illustrated Parts Manual",
      progress: 95,
      documents: 1,
    ...
    {
      code: "J 014",
      name: "Master Minimum Equipment List",
      progress: 100,
      documents: 1,
      lastUpdate: "1 day ago",
      assignee: "James T.",
    ...
    {
      code: "J 015",
      name: "Manufacturer's Maintenance Planning Document",
      progress: 90,
      documents: 1,
    ...
    {
      code: "J 016",
      name: "Dispatch Deviation Procedures Guide",
      progress: 95,
      documents: 1,
      lastUpdate: "1 day ago",
      assignee: "Tom W.",
    ...
    {
      code: "J 017",
      name: "Manufacturer's Cabin Crew Operating Manual (if applicable to Aircraft type)",
      progress: 85,
      documents: 1,
    ...
    {
      code: "J 018",
      name: "Passenger Seat Manuals (CMM & IPC), subject to proprietary data restrictions",
      progress: 90,
      documents: 1,
          ...
          <div className="bg-white">
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  <div className="h-16 w-16 rounded-lg bg-green-50 border-2 border-green-200 flex items-center justify-center">
                    <span className="text-3xl font-bold text-green-600">{folderInfo.letter}</span>
                  </div>
                  <div>
              ...
              {/* Subfolders Section */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-4">Aircraft Manuals</h3>
                      ...
                      <CardHeader className="pb-3">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            <div className="h-12 w-12 rounded-lg bg-green-50 border border-green-200 flex items-center justify-center flex-shrink-0">
                              <FileText className="h-6 w-6 text-green-600" />
                            </div>
                            <div>
                              <div className="text-xs font-semibold text-green-600 mb-1">{subfolder.code}</div>
                      ...
                      <CardContent className="space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-slate-200">
                          ...
                          <div className="flex items-center gap-1 text-xs text-slate-600">
                            ...
                            <span className="font-semibold text-green-600">{subfolder.party}</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>

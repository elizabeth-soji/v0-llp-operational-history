...
export default function FolderAPage() {
  const folderInfo = {
    letter: "A",
        ...
        <div className="mt-6">
          ...
          <div className="bg-white">
            <div className="p-6">
              ...
              {/* Subfolders Section */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-4">Certificate Documents</h3>
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    ...
                    {
                      code: "A 004",
                      name: "Noise Certificate (or equivalent)",
                      progress: 100,
                      status: "complete",
                      priority: "medium",
                      documents: 1,
                    ...
                    {
                      code: "A 005",
                      name: "Copy of Radio Station License",
                      progress: 75,
                      status: "in-progress",
                      priority: "medium",
                      documents: 1,
                    ...
                    {
                      code: "A 006",
                      name: "Aircraft De-Registration confirmation",
                      progress: 60,
                      status: "in-progress",
                      priority: "high",
                      documents: 1,

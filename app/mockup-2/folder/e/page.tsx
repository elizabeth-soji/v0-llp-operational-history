...
export default function FolderEPage() {
  const folderInfo = {
    letter: "E",
    name: "Aircraft Manufacturer Records",
    progress: 85,
    status: "in-progress",
    documents: 20, // Updated from 19 to 20 documents
  }

  const subfolders = [
    {
      code: "E 001",
      name: "Certificate of Airworthiness or Certificate of Airworthiness for Export at Manufacture",
      progress: 100,
      documents: 1,
    ...
    {
      code: "E 002",
      name: "Manufacturer report of Airworthiness Directives incorporated at Manufacture",
      progress: 95,
      documents: 1,
    ...
    {
      code: "E 003",
      name: "Manufacturer's original component fitted listing (e.g. Aircraft Inspection Report (Airbus) / Aircraft Readiness Log (Boeing))",
      progress: 90,
      documents: 1,
    ...
    {
      code: "E 004",
      name: "Manufacturer's Repair/Alteration Report/Significant Repair Log",
      progress: 88,
      documents: 1,
    ...
    {
      code: "E 005",
      name: "Manufacturer report of Modifications incorporated at manufacture",
      progress: 92,
      documents: 1,
    ...
    {
      code: "E 006",
      name: "Service Difficulty Reports (if any) / Delivery Inspection Report",
      progress: 85,
      documents: 1,
    ...
    {
      code: "E 007",
      name: "Production Aircraft Test Completion Record",
      progress: 80,
      documents: 1,
      lastUpdate: "1 day ago",
      assignee: "Anna P.",
    ...
    {
      code: "E 008",
      name: "Manufacture Flight Logs (Hours and Cycles recorded)",
      progress: 75,
      documents: 1,
      lastUpdate: "1 day ago",
      assignee: "Tom W.",
    ...
    {
      code: "E 009",
      name: "Aircraft Historical / Miscellaneous Log (Boeing)",
      progress: 88,
      documents: 1,
    ...
    {
      code: "E 010",
      name: "Manufacturer Report of Landing Gear Life Limited Parts installed at Manufacture",
      progress: 90,
      documents: 1,
    ...
    {
      code: "E 011",
      name: "Statement of the Aircraft eligible Type Certification",
      progress: 95,
      documents: 1,
      lastUpdate: "1 day ago",
      assignee: "Sarah C.",
    ...
    {
      code: "E 012",
      name: "Certified Aircraft Weighing Report at Manufacture",
      progress: 85,
      documents: 1,
    ...
    {
      code: "E 014",
      name: "Production Flight Certificate",
      progress: 78,
      documents: 1,
    ...
    {
      code: "E 017",
      name: "Certificate of Sanitary Construction",
      progress: 88,
      documents: 1,
      lastUpdate: "1 day ago",
      assignee: "Anna P.",
    ...
    {
      code: "E 018",
      name: "Detailed Specification / Technical Description Document",
      progress: 90,
      documents: 1,
    ...
    {
      code: "E 019",
      name: "Interior Finish Specification Document",
      progress: 85,
      documents: 1,
    ...
    {
      code: "E 020",
      name: "Customer Checklist Document (if applicable)",
      progress: 70,
      documents: 1,
          ...
          <div className="bg-white">
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  <div className="h-16 w-16 rounded-lg bg-rose-50 border-2 border-rose-200 flex items-center justify-center">
                    <span className="text-3xl font-bold text-rose-600">{folderInfo.letter}</span>
                  </div>
                  <div>
              ...
              {/* Subfolders Section */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-4">Manufacturer Records</h3>
                      ...
                      <CardHeader className="pb-3">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            <div className="h-12 w-12 rounded-lg bg-rose-50 border border-rose-200 flex items-center justify-center flex-shrink-0">
                              <FileText className="h-6 w-6 text-rose-600" />
                            </div>
                            <div>
                              <div className="text-xs font-semibold text-rose-600 mb-1">{subfolder.code}</div>
                      ...
                      <CardContent className="space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-slate-200">
                          ...
                          <div className="flex items-center gap-1 text-xs text-slate-600">
                            ...
                            <span className="font-semibold text-rose-600">{subfolder.party}</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>

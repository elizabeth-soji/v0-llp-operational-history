...
const documentSections = [
  {
    ...
    viewerLink: "/mockup-2/folder/f1/viewer",
    keyData: [
  ...
  },
  {
    ...
    viewerLink: "/mockup-2/folder/f1/viewer/arc",
    keyData: [
  ...
  },
  {
    ...
    viewerLink: "/mockup-2/folder/f1/viewer/llp-status",
    keyData: [
  ...
  },
  {
    ...
    viewerLink: "/mockup-2/folder/f1/viewer/incident-clearance",
    keyData: [
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {pdfUrl ? (
              <Link
                href="/mockup-2/folder/f1/viewer"

...
// Page data using Authorized Release Certificate image
const pages = [
  {
    id: 1,
    thumbnail: "/documents/sia-auth-release-certificate.jpg",
  },
]

export default function ARCViewerPage() {
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col">
      ...
      <div className="bg-slate-700 px-4 py-2 flex items-center justify-between text-white">
        ...
        <div className="flex items-center gap-1">
          ...
          {/* Actions */}
          <a href="/documents/sia-auth-release-certificate.jpg" download>
            <Button
              variant="ghost"
              size="icon"
              className="h-8 w-8 text-white hover:bg-slate-600"
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 bg-slate-500 overflow-auto p-8 flex justify-center">
          ...
          >
            {/* Display Authorized Release Certificate Image */}
            <img
              src="/documents/sia-auth-release-certificate.jpg"
              alt="FAA Form 8130-3 - Authorized Release Certificate"

...
export default function FolderDPage() {
  const folderInfo = {
    letter: "D",
          ...
          <div className="bg-white">
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  <div className="h-16 w-16 rounded-lg bg-amber-50 border-2 border-amber-200 flex items-center justify-center">
                    <span className="text-3xl font-bold text-amber-600">{folderInfo.letter}</span>
                  </div>
                  <div>
              ...
              {/* Subfolders Section */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-4">Configuration Status Documents</h3>
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    {
                      code: "D 001",
                      name: "Layout of Passenger Accommodation (LOPA) drawing including Seat Part Numbers",
                      progress: 95,
                      documents: 1,
                    ...
                    {
                      code: "D 003",
                      name: "Emergency Equipment Drawing with item description and Part Numbers",
                      progress: 85,
                      documents: 1,
                    ...
                    {
                      code: "D 004",
                      name: "Inventory of Loose and Galley Equipment",
                      progress: 92,
                      documents: 1,
                    ...
                    {
                      code: "D 005",
                      name: "Inventory Listing of Avionics Units installed (E and E Bay)",
                      progress: 88,
                      documents: 1,
                      ...
                      <CardHeader className="pb-3">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            <div className="h-12 w-12 rounded-lg bg-amber-50 border border-amber-200 flex items-center justify-center flex-shrink-0">
                              <FileText className="h-6 w-6 text-amber-600" />
                            </div>
                            <div>
                              <div className="text-xs font-semibold text-amber-600 mb-1">{subfolder.code}</div>
                      ...
                      <CardContent className="space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-slate-200">
                          ...
                          <div className="flex items-center gap-1 text-xs text-slate-600">
                            ...
                            <span className="font-semibold text-amber-600">{subfolder.party}</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>

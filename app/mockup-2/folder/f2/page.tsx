...
export default function FolderF2Page() {
  const folderInfo = {
    letter: "F2",
          ...
          <div className="bg-white">
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  <div className="h-16 w-16 rounded-lg bg-cyan-50 border-2 border-cyan-200 flex items-center justify-center">
                    <span className="text-2xl font-bold text-cyan-600">{folderInfo.letter}</span>
                  </div>
                  <div>
              ...
              {/* Subfolders Section */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-4">Engine Record Documents</h3>
                        ...
                        <CardHeader className="pb-3">
                          <div className="flex items-start justify-between">
                            <div className="flex items-center gap-3">
                              <div className="h-12 w-12 rounded-lg bg-cyan-50 border border-cyan-200 flex items-center justify-center flex-shrink-0">
                                <FileText className="h-6 w-6 text-cyan-600" />
                              </div>
                              <div>
                                <div className="text-xs font-semibold text-cyan-600 mb-1">{subfolder.code}</div>
                        ...
                        <CardContent className="space-y-3">
                          ...
                          <div className="flex items-center justify-between pt-2 border-t border-slate-200">
                            ...
                            <div className="flex items-center gap-1 text-xs text-slate-600">
                              ...
                              <span className="font-semibold text-cyan-600">{subfolder.party}</span>
                            </div>
                          </div>
                        </CardContent>
                      </Link>

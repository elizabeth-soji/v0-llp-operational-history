...
const llpData = [
  {
    id: 1,
    item: 1,
    description: "SHAFT, REAR HPT",
    partNumber: "1864M90P04",
    serialNumber: "TMT1AD99",
    tsn: "18734",
    cycleTotal: "11962",
    cycleLimit: "20000",
    cycleRemaining: "8038",
    status: "In Progress",
    aiFindings: "Yes",
    link: "/mockup-2/folder/f2/f008/back-to-birth",
  },
  {
    id: 2,
    item: 2,
    description: "DISK HPT",
    partNumber: "1498M43P06",
    serialNumber: "GWN0MD09",
    tsn: "18734",
    cycleTotal: "11962",
    cycleLimit: "20000",
    cycleRemaining: "8038",
  ...
  },
  {
    id: 3,
    item: 3,
    description: "SEAL, AIR HPT",
    partNumber: "1795M36P02",
    serialNumber: "TMT6Y148",
    tsn: "18734",
    cycleTotal: "11962",
    cycleLimit: "17600",
    cycleRemaining: "5638",
  ...
  },
  {
    id: 4,
    item: 4,
    description: "SHAFT, FORWARD HPT",
    partNumber: "1873M73P01",
    serialNumber: "XAEM6417",
    tsn: "18734",
    cycleTotal: "11962",
    cycleLimit: "17600",
    cycleRemaining: "5638",
  ...
  },
  {
    id: 5,
    item: 5,
    description: "SEAL, AIR HPC",
    partNumber: "1523M35P01",
    serialNumber: "GFF5ECF6",
    tsn: "18734",
    cycleTotal: "11962",
    cycleLimit: "18600",
    cycleRemaining: "6638",
...
export default function FolderF2F008Page() {
            ...
            <Card className="bg-white border-slate-200">
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-600 mb-4">
                  ...
                  <Link href="/mockup-2/folder/f2" className="hover:text-slate-900 transition-colors">
                    {folderInfo.letter}. {folderInfo.name}
                  </Link>
                  <ChevronRight className="h-4 w-4" />
                  <span className="font-semibold text-slate-900">
                    F 008. Life Limited Parts
                  </span>
                </div>
